...
try {
    ...
    if (Test-Path -LiteralPath 'scripts/aicoding-tag-governance.ps1') {
        $args = @('-NoProfile', '-ExecutionPolicy', 'Bypass', '-File', 'scripts/aicoding-tag-governance.ps1', '-Action', 'Verify', '-Json')
