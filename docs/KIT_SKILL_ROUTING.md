...
```powershell
bin/aicoding.exe skills -All -Json
bin/aicoding.exe verify-skills -All -Json
bin/aicoding.exe skills -Kit aicoding-agent-dev-kit -Json
bin/aicoding.exe verify-skills -Kit aicoding-agent-dev-kit -Json
```
