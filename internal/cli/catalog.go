...
var commands = mustCommandCatalog(
	...
	[]HelpForm{
		...
		{Command: CommandCache, Section: HelpDomain, Usage: "aicoding cache clean [--scope fast-path|test-results|validation-reports|temp|work-state|pins] [--keep N] [--dry-run] [--adopt] [--all-repos] [--repo-root PATH] [--json]"},
		...
		{Command: CommandKit, Section: HelpDomain, Usage: "aicoding kit register --manifest PATH [--prefetch] [--repo-root PATH] [--json]"},
		{Command: CommandKit, Section: HelpDomain, Usage: "aicoding kit prefetch --id ID [--repo-root PATH] [--json]"},
