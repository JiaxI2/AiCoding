...
func TestScanPwshBudgetClassifiesInvocationPoints(t *testing.T) {
	...
	mustWrite(t, filepath.Join(repo, ".githooks", "pre-commit"), "bin/aicoding.exe hook pre-commit --json || pwsh -File scripts/legacy/fast-path-replaced/lint-git-governance.ps1\n")
