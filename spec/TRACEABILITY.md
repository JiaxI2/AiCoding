...
| Keep existing AiCoding hook model | `config/hooks-registry.json`, `scripts/invoke-aicoding-agent-hook.ps1` | `bin\aicoding.exe verify hooks --json`, `scripts/verify-agent-engineering-foundation.ps1 -Json` |
