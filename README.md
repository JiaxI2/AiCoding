...
> 此区由 `config/internal-capabilities.json` 生成（`sha256:1f915ac583c9dc8d7661c87741942fc68d96c3439dbc797a734f0e8fe7523fdd`）。完整的 29 项能力见 [能力索引](docs/CAPABILITIES.md)。
